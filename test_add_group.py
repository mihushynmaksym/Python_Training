...
class test_add_group(unittest.TestCase):
    ...
    def test_test_add_group(self):
        ...
        wd.find_element_by_name("group_name").send_keys("cxzvdf")
        ...
        wd.find_element_by_name("group_header").send_keys("sdasqw")
        wd.find_element_by_name("group_footer").click()
        wd.find_element_by_name("group_footer").clear()
        wd.find_element_by_name("group_footer").send_keys("xzzc")
